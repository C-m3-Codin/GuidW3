...
class Guide extends _i1.GeneratedContract {
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<bool> isInstitution(_i1.EthereumAddress $param2,
      {_i1.BlockNum? atBlock}) async {
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<UserProfiles> userProfiles(_i1.EthereumAddress $param3,
      {_i1.BlockNum? atBlock}) async {
  ...
  Future<_i1.EthereumAddress> getCurrentUserAddress(
    ...
    final params = [];
    final response = await read(function, params, atBlock);
    print("response current address is $response");
    return (response[0] as _i1.EthereumAddress);
  }
}
